...
static void (*GOMP_parallel_real)(void*, void*, unsigned, unsigned int) = __real_GOMP_parallel;
 ...
 */
static unsigned __GOMP_doacross_ncounts[MAX_NESTING_LEVEL]; 
...
void __wrap_GOMP_atomic_end (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_critical_start (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_critical_end (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_critical_name_start (void **pptr)
{
#if defined(DEBUG)
...
void __wrap_GOMP_critical_name_end (void **pptr)
{
#if defined(DEBUG)
...
int __wrap_GOMP_loop_static_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
...
int __wrap_GOMP_loop_dynamic_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_guided_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_runtime_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_static_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_dynamic_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_guided_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_runtime_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_static_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_dynamic_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_guided_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_runtime_start (long start, long end, long incr, long chunk_size, long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_static_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_dynamic_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_guided_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_ordered_runtime_next (long *istart, long *iend)
{
	int res = 0;
#if defined(DEBUG)
...
void
__wrap_GOMP_parallel_loop_static_start(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_loop_dynamic_start(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_loop_guided_start(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
//
void
__wrap_GOMP_parallel_loop_runtime_start(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr)
{
#if defined(DEBUG)
	fprintf (stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void __wrap_GOMP_loop_end (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_loop_end_nowait (void)
{
#if defined(DEBUG)
...
//
void __wrap_GOMP_ordered_start (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_ordered_end (void)
{
#if defined(DEBUG)
...
void
__wrap_GOMP_parallel_start(void (*fn)(void *), void *data, unsigned num_threads)
{
#if defined(DEBUG)
	fprintf (stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
OMP_parallel_sections_start(void (*fn)(void *), void *data, unsigned num_threads, unsigned count)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
unsigned __wrap_GOMP_sections_start (unsigned count)
{
	unsigned res = 0;
#if defined(DEBUG)
...
unsigned __wrap_GOMP_sections_next (void)
{
	unsigned res = 0;
#if defined(DEBUG)
...
void __wrap_GOMP_sections_end (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_sections_end_nowait (void)
{
#if defined(DEBUG)
...
unsigned __wrap_GOMP_single_start (void)
{
	unsigned res = 0;
#if defined(DEBUG)
...
void __wrap_GOMP_taskwait (void)
{
#if defined(DEBUG)
...
//
void
__wrap_GOMP_parallel(void (*fn)(void *), void *data, unsigned num_threads, unsigned int flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_loop_static(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size, unsigned flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_loop_dynamic(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size, unsigned flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void __wrap_GOMP_parallel_loop_guided(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, long chunk_size, unsigned flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_loop_runtime(void (*fn)(void *), void *data, unsigned num_threads, long start, long end, long incr, unsigned flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void
__wrap_GOMP_parallel_sections(void (*fn) (void *), void *data, unsigned num_threads, unsigned count, unsigned flags)
{
#if defined(DEBUG)
	fprintf(stderr, PACKAGE_NAME ":" THREAD_LEVEL_LBL
...
void __wrap_GOMP_taskgroup_start (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_taskgroup_end (void)
{
#if defined(DEBUG)
...
void __wrap_GOMP_task (void (*fn)(void *), void *data, void (*cpyfn)(void *, void *), long arg_size, long arg_align, int if_clause, unsigned flags, ...)
{
	void **depend = NULL;
	int priority = 0;
	va_list ap;
...
void __wrap_GOMP_taskloop (void *fn, void *data, void *cpyfn, long arg_size, long arg_align, unsigned flags, unsigned long num_tasks, int priority, long start, long end, long step)
{
#if defined(DEBUG)
...
int __wrap_GOMP_loop_doacross_static_start (unsigned ncounts, long *counts, long chunk_size, long *istart, long *iend)
{
	int res;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_doacross_dynamic_start (unsigned ncounts, long *counts, long chunk_size, long *istart, long *iend)
{
	int res;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_doacross_guided_start (unsigned ncounts, long *counts, long chunk_size, long *istart, long *iend)
{
	int res;
#if defined(DEBUG)
...
int __wrap_GOMP_loop_doacross_runtime_start (unsigned ncounts, long *counts, long *istart, long *iend)
{
	int res;
#if defined(DEBUG)
...
void __wrap_GOMP_doacross_post (long *counts)
{
#if defined(DEBUG)
...
// * that script.
// */
void __wrap_GOMP_doacross_wait (long first, ...)
{
	unsigned i = 0;
...
static int gnu_libgomp_get_hook_points (int rank)
{
  ...
  /**********************/
	...
	/* Obtain @ for GOMP_atomic_start */
	GOMP_atomic_start_real =
		(void(*)(void)) __real_GOMP_atomic_start;
	...
	GOMP_loop_ordered_static_start_real =
		(int(*)(long, long, long, long, long *, long *)) __real_GOMP_loop_ordered_static_start;
	...
	GOMP_loop_ordered_dynamic_start_real =
		(int(*)(long, long, long, long, long *, long *)) __real_GOMP_loop_ordered_dynamic_start;
	...
	GOMP_loop_ordered_guided_start_real =
		(int(*)(long, long, long, long, long *, long *)) __real_GOMP_loop_ordered_guided_start;
	...
	GOMP_loop_ordered_runtime_start_real =
		(int(*)(long, long, long, long, long *, long *))__real_GOMP_loop_ordered_runtime_start;
	...
	GOMP_loop_ordered_static_next_real =
		(int(*)(long*,long*)) __real_GOMP_loop_ordered_static_next;
	...
	GOMP_loop_ordered_dynamic_next_real =
		(int(*)(long*,long*))__real_GOMP_loop_ordered_dynamic_next;
	...
	GOMP_loop_ordered_guided_next_real =
		(int(*)(long*,long*)) __real_GOMP_loop_ordered_guided_next;
	INC_IF_NOT_NULL(GOMP_loop_ordered_guided_next_real,count);

	/* Obtain @ for GOMP_loop_runtime_next */
	GOMP_loop_ordered_runtime_next_real =
		(int(*)(long*,long*)) __real_GOMP_loop_ordered_runtime_next;
	...
	GOMP_parallel_loop_static_start_real =
		(void(*)(void*,void*,unsigned, long, long, long, long)) __real_GOMP_parallel_loop_static_start;
	...
	GOMP_parallel_loop_dynamic_start_real =
		(void(*)(void*,void*,unsigned, long, long, long, long)) __real_GOMP_parallel_loop_dynamic_start;
	...
	GOMP_parallel_loop_guided_start_real =
		(void(*)(void*,void*,unsigned, long, long, long, long)) __real_GOMP_parallel_loop_guided_start;
  ...
  /**********************/
	...
	GOMP_task_real =
		(void(*)(void*,void*,void*,long,long,int,unsigned,...))__real_GOMP_task; // Wrap
	INC_IF_NOT_NULL(GOMP_task_real,count);

	/* Obtain @ for GOMP_taskloop */
	GOMP_taskloop_real =
		(void(*)(void*,void*,void*,long,long,unsigned,unsigned long,int,long,long,long))__real_GOMP_taskloop; // Wrap
	INC_IF_NOT_NULL(GOMP_taskloop_real,count);

	/* Obtain @ for GOMP_loop_doacross_static_start */
	GOMP_loop_doacross_static_start_real = (int(*)(unsigned, long *, long, long *, long *))__real_GOMP_loop_doacross_static_start;
	INC_IF_NOT_NULL(GOMP_loop_doacross_static_start_real,count);

	/* Obtain @ for GOMP_loop_doacross_dynamic_start */
	GOMP_loop_doacross_dynamic_start_real = (int(*)(unsigned, long *, long, long *, long *))__real_GOMP_loop_doacross_dynamic_start;
	INC_IF_NOT_NULL(GOMP_loop_doacross_dynamic_start_real,count);

	/* Obtain @ for GOMP_loop_doacross_guided_start */
	GOMP_loop_doacross_guided_start_real = (int(*)(unsigned, long *, long, long *, long *))__real_GOMP_loop_doacross_guided_start;
	INC_IF_NOT_NULL(GOMP_loop_doacross_guided_start_real,count);

	/* Obtain @ for GOMP_loop_doacross_runtime_start */
	GOMP_loop_doacross_runtime_start_real = (int(*)(unsigned, long *, long *, long *))__real_GOMP_loop_doacross_runtime_start;
	INC_IF_NOT_NULL(GOMP_loop_doacross_runtime_start_real,count);

	/* Obtain @ for GOMP_doacross_post */
	GOMP_doacross_post_real = (void(*)(long *))__real_GOMP_doacross_post;
	INC_IF_NOT_NULL(GOMP_doacross_post_real,count);

	/* Obtain @ for GOMP_doacross_wait */
	GOMP_doacross_wait_real = (void(*)(long, ...))__real_GOMP_doacross_wait;
