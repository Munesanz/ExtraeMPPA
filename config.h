...
/* Define if architecture is SPARC */
#define ARCH_SPARC 1
...
/* #undef HAVE_PERF_EVENT_MMAP_PAGE_DATA_SIZE */

/* Whether the system includes perf_mem_data_src/val */
/* #undef HAVE_PERF_MEM_DATA_SRC */
...
/* L4STAT is used as API to gain access to CPU hwc */
/* #undef L4STAT */
...
/* #undef MPI_SUPPORTS_MPI_GET_ACCUMULATE */
...
/* Define if operating system is RTEMS */
#define OS_RTEMS 1
...
#define PACKAGE_STRING "Extrae 3.7.1"
